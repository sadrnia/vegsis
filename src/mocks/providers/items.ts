    ...
    let items = [
      {
        ...
        "ing15":"" ,
        "ingredients":"" ,
        "makeit1":"بر روی حرارت ملایم، شیرسویا، سس کچاپ، سرکه، شکر، فلفل و پودر سیر را در داخل ظرفی قرار دهید" ,
        "makeit2":" به مدت ۵ تا ١٠ دقیقه اجازه دهید که سس شما پخته شود تا اینکه کم کم غلیظ شود" ,
        "makeit3":" بعد از اینکه سس خنک شده آن را داخل ظرف مناسب ریخته و در یخچال نگهداری کنید" ,
        "makeit4":"" ,
        "makeit5":"" ,
        "makeit6":"" ,
        "makeit7":"" ,
